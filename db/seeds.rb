...
# Cats
c1 = Cat.create!(name: "Whiskers", age: 3)
c2 = Cat.create!(name: "Mittens", age: 2)
c3 = Cat.create!(name: "Shadow", age: 4)
c4 = Cat.create!(name: "Smokey", age: 1)

# Assign multiple owners
c1.users << [u1, u2] # Whiskers is owned by Elle & Alex
c2.users << u1
c3.users << u2
c4.users << u3
...
# Photos
Photo.create!(cat: c1, image_url: "https://placekitten.com/300/300", caption: "Whiskers playing")
Photo.create!(cat: c2, image_url: "https://placekitten.com/301/301", caption: "Mittens sleeping")
Photo.create!(cat: c3, image_url: "https://placekitten.com/302/302", caption: "Shadow on the couch")
